# 4. ¿Cómo se adopta sin quitarle nada a nadie?
...
Un paradigma superior que no se puede adoptar es una curiosidad académica. Este capítulo trata la pregunta gerencial: ¿cómo llega una organización real — con su gente real y su apego real a las herramientas — del canal al Postchat sin un motín?
...
> - Postchat se despliega como modo opcional y reversible; la unidad de adopción es un usuario, no la empresa.
