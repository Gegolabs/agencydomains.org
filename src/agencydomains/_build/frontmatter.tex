...
\textbf{Edición:} Primera edición · Septiembre 2026 (v1.2)\\
\textbf{Licencia:} GNU Free Documentation License v1.3

\vspace{1cm}

\noindent Este libro se publica bajo GNU Free Documentation License v1.3. El lector puede copiar, distribuir y modificar la obra bajo los términos de la licencia. La sección invariante es el Prefacio.

\vspace{0.8cm}

\noindent\textbf{Cómo citar:}\\
Obach-Renner, César. \emph{AgencyDomains: arquitectura del Mundo Agentivo}. Primera edición v1.2. GegoLabs, 2026.
