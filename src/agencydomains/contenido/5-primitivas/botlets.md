...
**Botler** es la infraestructura que ejecuta las unidades de la Capa 3 (Autonomía) — los Botlets que esta sección desarrolla y los Agentlets que el §7 formaliza como su especie hermana. Es invisible para el usuario y para el agente; es responsabilidad de la implementación del AgencyDomain. La relación canónica es simple y se enuncia sobre el género: un proceso del AgencyDomain contiene un Botler, y el Botler gestiona N unidades que viven dentro de ese proceso — **1 Proceso = 1 Botler + N unidades**. En esta sección, donde las unidades son Botlets, la relación se instancia como 1 Botler + N Botlets.
